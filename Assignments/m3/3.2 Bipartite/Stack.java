 ...
 * operations, along with methods for peeking at
 * the top item, testing if the
 * stack is empty, and iterating through the
 * items in LIFO order. <p> All stack
 * operations except iteration are constant time.
 * <p> For additional
 * documentation, see <a href="/algs4/13stacks">
 * Section 1.3</a> of
